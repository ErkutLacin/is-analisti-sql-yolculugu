...
## 🧪 Nasıl Çalıştırılır?
Önce [`musteri_islemleri`](alistirmalar/05-select-temelleri/musteri_islemleri_tablosu.sql) tablosunun oluşturulduğu veri seti dosyasını çalıştırın, ardından bu alıştırmayı adım adım uygulayın.
